...
class RecurringDonationCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        self.iconImageView.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 16).isActive = true
        ...
        self.iconImageView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -16).isActive = true
